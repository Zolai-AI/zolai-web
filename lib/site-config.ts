...
export async function getSiteConfig(): Promise<SiteConfigData> {
  try {
    ...
    const config: SiteConfigData = {
      ...
      allowRegistration: getBoolValue(SITE_CONFIG_KEYS.ALLOW_REGISTRATION, true),
      requireEmailVerification: getBoolValue(SITE_CONFIG_KEYS.REQUIRE_EMAIL_VERIFICATION, true),
      require2fa: getBoolValue(SITE_CONFIG_KEYS.REQUIRE_2FA, false),
      noReplyEmail: getStringValue(SITE_CONFIG_KEYS.NOREPLY_EMAIL, ""),
      sessionTimeoutMinutes: getNumberValue(SITE_CONFIG_KEYS.SESSION_TIMEOUT, 10080),
      moderationRequired: getBoolValue(SITE_CONFIG_KEYS.MODERATION_REQUIRED, false),
